...
const Info = () => {
  return (
    ...
    <div className="about">
      ...
      <div>
        <p> For booking or to rent space checkout <Link href="/rent">our rental page</Link> or contact ps37durham@gmail.com or drop us a dm on twitter or the insta @ps37durham</p>
